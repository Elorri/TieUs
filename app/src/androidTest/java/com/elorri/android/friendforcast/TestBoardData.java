...
public class TestBoardData extends AndroidTestCase {
    ...
    static final long todayStart = DateUtils.todayStart();
    static final long in30days = DateUtils.addDay(30, todayStart);
    static final long frequency30days = in30days - todayStart;
    ...
    private static final String ALWAYS_DISPLAYED_CURSOR = "header |"
            ...
            + R.drawable.ic_social_network + "|" + DateUtils.addDay(-2, todayStart) + "|"
            + DateUtils.addDay(-1, todayStart) + "|null|null|" + FriendForecastContract.ContactTable.UNTRACKED_OFF_VALUE
            ...
            + R.drawable.ic_social_network + "|" + DateUtils.addDay(-2, todayStart) + "|"
            + DateUtils.addDay(+2, todayStart) + "|null|null|" + FriendForecastContract.ContactTable.UNTRACKED_OFF_VALUE
            + "|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "row |19|836|298i5.3552i264b0e968b8a42fd|mathieu|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|" + DateUtils.addDay(-2, todayStart) + "|"
            + DateUtils.addDay(+2, todayStart) + "|null|null|" + FriendForecastContract.ContactTable.UNTRACKED_OFF_VALUE
            + "|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "row |22|839|298i5.3552i274b0e968b8a47fv|mélissa|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|" + DateUtils.addDay(-2, todayStart) + "|"
            + DateUtils.addDay(-1, todayStart) + "|" + frequency30days + "|null|"
            + FriendForecastContract.ContactTable.UNTRACKED_OFF_VALUE
            + "|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            ...
            + R.drawable.ic_social_network + "|" + DateUtils.addDay(-2, todayStart) + "|"
            + DateUtils.addDay(-1, todayStart) + "|null|null|" + FriendForecastContract.ContactTable.UNTRACKED_ON_VALUE
            + "|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            ...
            + R.drawable.ic_social_network + "|" + DateUtils.addDay(-2, todayStart) + "|"
            + DateUtils.addDay(+2, todayStart) + "|null|null|" + FriendForecastContract.ContactTable.UNTRACKED_ON_VALUE
            + "|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
    ...
    public void testUpdateMoodMessage() {
        ...
        String cursorString = "\n"
                ...
                + "row |18|835|298i5.3552i264b0e968b8a42fv|jeanne|null|"
                + R.drawable.ic_social_network + "|" + DateUtils.addDay(-2, todayStart) + "|"
                + DateUtils.addDay(+2, todayStart) + "|null|null|"
                + FriendForecastContract.ContactTable.UNTRACKED_OFF_VALUE
    ...
    public void testSetUpAFrequencyOfContact() {
        ...
        String cursorString = "\n"
                ...
                + "row |19|836|298i5.3552i264b0e968b8a42fd|mathieu|null|"
                + R.drawable.ic_sentiment_neutral_black_48dp + "|" + DateUtils.addDay(-2, TestBoardData.todayStart) + "|"
                + DateUtils.addDay(+2, TestBoardData.todayStart) + "|null|null|" + FriendForecastContract.ContactTable
                .UNTRACKED_OFF_VALUE
    ...
    public void testAskForFeedbackOrMoveToUntrackMessage() {
        ...
        String cursorString = "\n"
                ...
                + "row |20|837|298i5.3552i264b0e968b8a46fv|denis|null|"
                + R.drawable.ic_social_network + "|" + DateUtils.addDay(-2, todayStart) + "|"
                + DateUtils.addDay(-1, todayStart) + "|null|null|" + FriendForecastContract.ContactTable
                .UNTRACKED_OFF_VALUE
    ...
    //TODO I still don't get why contact 15 unmanaged seems to be updated
...
//        String lastMoodUpdate = cursor.getString(ContactActionVectorEventDAO
//                .PeopleWhoDecreasedMoodQuery.COL_LAST_MOOD_DECREASED);
//        Log.e("FF", Thread.currentThread().getStackTrace()[2] + "" + lastMoodUpdate);
...
//                + "row |22|839|298i5.3552i274b0e968b8a47fv|mélissa|null|"
//                + R.drawable.ic_sentiment_neutral_black_48dp + "|" + DateUtils.addDay(-2, todayStart) + "|"
//                + DateUtils.addDay(-1, todayStart) + "|" + frequency30days + "|"
//                + lastMoodUpdate + "|"
//                + FriendForecastContract.ContactTable.UNTRACKED_OFF_VALUE
