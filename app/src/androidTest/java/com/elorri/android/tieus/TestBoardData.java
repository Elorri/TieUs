...
public class TestBoardData extends AndroidTestCase {
    ...
    private static final String ALWAYS_DISPLAYED_CURSOR = "header |"
            ...
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+"|-6190977|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "row |24|850|288i7.3552i264b0e968b8a42ff|emma|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+ "|-4560696|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            ...
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE + "|-30107|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            ...
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+"|-11677471|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            ...
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-11549705|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            ...
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-10177034|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "header |"
            + MatrixCursors.TitleQuery.COLUMN_TITLE + "|" + ViewTypes.COLUMN_VIEWTYPE + "|\n"
            ...
            + R.drawable.ic_sentiment_neutral_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-18611|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |40|937|398i5.3552i264b0e968b8a46fv|denis_untracked|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|" + TestGivens._1day + "|" + TestGivens._2days + "|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+"|-6190977|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |44|950|398i9.3552i264b0e968b8a42ff|emma_untracked|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+ "|-4560696|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |43|940|398i7.3552i264b0e968b8a42ff|françoise_untracked|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE + "|-1739917|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            ...
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE + "|-30107|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |39|936|398i5.3552i264b0e968b8a42fd|mathieu_untracked|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+"|-11677471|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |42|939|398i5.3552i274b0e968b8a47fv|mélissa_untracked|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._3days + "|" + TestGivens._30days + "|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-11549705|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |35|932|398i5.3552i264b0e968b8a42ff|paul_untracked|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-1739917|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |36|933|398i5.3552i264b0e968b8a42fk|pierre_untracked|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-4560696|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |41|938|398i5.3552i264b0e968b8a47fv|émilie_untracked|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|" + TestGivens._30days + "|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-10177034|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n";
    ...
    private static final String ALWAYS_DISPLAYED_CURSOR_MOOD_MELISSA_UPDATED = "header |"
            ...
            + "row |17|834|298i5.3552i264b0e968b8a42fl|jacques|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+"|-18611|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "row |18|835|298i5.3552i264b0e968b8a42fv|jeanne|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE + "|-30107|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "row |19|836|298i5.3552i264b0e968b8a42fd|mathieu|null|"
            ...
            + "row |15|832|298i5.3552i264b0e968b8a42ff|paul|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-1739917|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "row |21|838|298i5.3552i264b0e968b8a47fv|émilie|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|" + TestGivens._30days + "|null|"
            + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-10177034|" + ViewTypes.VIEW_UNMANAGED_PEOPLE + "|\n"
            + "header |"
            ...
            + "row |45|951|390i5.3552i264b0e968b8a42fk|bernard_untracked|null|"
            + R.drawable.ic_sentiment_neutral_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE
            + "|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |40|937|398i5.3552i264b0e968b8a46fv|denis_untracked|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|" + TestGivens._1day + "|" + TestGivens._2days + "|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+"|-6190977|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            ...
            + "row |37|934|398i5.3552i264b0e968b8a42fl|jacques_untracked|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|null|null|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+"|-18611|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |38|935|398i5.3552i264b0e968b8a42fv|jeanne_untracked|null|"
            + R.drawable.ic_sentiment_satisfied_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|null|null|"
            + TieUsContract.ContactTable.UNTRACKED_ON_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE + "|-30107|" + ViewTypes.VIEW_UNTRACKED_PEOPLE + "|\n"
            + "row |39|936|398i5.3552i264b0e968b8a42fd|mathieu_untracked|null|"
    ...
    public void testUpdateMoodMessage() {
        ...
        String cursorString = "\n"
                ...
                + "row |18|835|298i5.3552i264b0e968b8a42fv|jeanne|null|"
                + R.drawable.ic_sentiment_satisfied_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|null|null|"
                + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE + "|-30107|" + ViewTypes.VIEW_UPDATE_MOOD + "|\n"
                + ALWAYS_DISPLAYED_CURSOR;
    ...
    public void testSetUpAFrequencyOfContact() {
        ...
        String cursorString = "\n"
                ...
                + "row |19|836|298i5.3552i264b0e968b8a42fd|mathieu|null|"
                + R.drawable.ic_sentiment_neutral_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|null|null|"
                + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+"|-11677471|" + ViewTypes.VIEW_SET_UP_A_FREQUENCY_OF_CONTACT + "|\n"
                + ALWAYS_DISPLAYED_CURSOR;
    ...
    public void testAskForFeedbackOrMoveToUntrackMessage() {
        ...
        String cursorString = "\n"
                ...
                + "row |20|837|298i5.3552i264b0e968b8a46fv|denis|null|"
                + R.drawable.ic_sentiment_satisfied_black_48dp + "|" + TestGivens._1day + "|" + TestGivens._2days + "|null|null|"
                + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_ON_VALUE+"|-6190977|" + ViewTypes.VIEW_ASK_FOR_FEEDBACK_OR_MOVE_TO_UNTRACK + "|\n"
                + ALWAYS_DISPLAYED_CURSOR;
    ...
    public void testApprochingDeadLineMessage() {
        ...
        String cursorString = "\n"
                ...
                + "row |21|838|298i5.3552i264b0e968b8a47fv|émilie|null|"
                + R.drawable.ic_sentiment_neutral_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._4days + "|" + TestGivens._30days + "|null|"
                + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE+ "|-10177034|" + ViewTypes.VIEW_APPROCHING_END_OF_MOST_SUITABLE_CONTACT_DELAY + "|\n"
                + ALWAYS_DISPLAYED_CURSOR;
...
//                + R.drawable.ic_sentiment_neutral_black_48dp + "|" + TestGivens._2days + "|" + TestGivens._3days + "|"
//                + TestGivens._30days + "|"+TestGivens.now_19may2016at12h40m52s+"|"
//                + TieUsContract.ContactTable.UNTRACKED_OFF_VALUE + "|" + TieUsContract.ContactTable.MOOD_UNKNOWN_OFF_VALUE
